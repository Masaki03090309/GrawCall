    ...
    try {
        ...
        if (statusResult.status === 'connected' && callRecord.project_id) {
            ...
            if (projectError) {
                ...
                await (0, slackNotification_1.sendSlackNotification)(projectData.slack_webhook_url, {
            ...
            console.log(`Skipping Slack notification (status: ${statusResult.status}, has project: ${!!callRecord.project_id})`);
        }
